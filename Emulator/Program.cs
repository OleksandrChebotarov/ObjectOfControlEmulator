...
namespace HydroelectricPowerPlantCS
{
    class Program
    {
        ...
        private static HydroelectricPowerPlant hydroPlant = new HydroelectricPowerPlant();
        ...
        static async Task Main(string[] args)
        {
            ...
            {
                {"WaterLevel", () => new WaterLevelSensor("Water Level", "Monitors water level.") },
                {"Pressure", () => new PressureSensor("Pressure", "Monitors system pressure.") },
                {"FlowRate", () => new FlowRateSensor("Flow Rate", "Monitors water flow rate.") },
                {"Temperature", () => new TemperatureSensor("Temperature", "Monitors water temperature.") },
                {"pH", () => new pHSensor("pH Level", "Monitors water acidity.") },
                {"Turbidity", () => new TurbiditySensor("Turbidity", "Monitors water clarity.") }
            };
        ...
        private static double GenerateValue(double targetValue, double currentValue, IndicatorModel indicatorModel)
        {
            ...
            var value = hydroPlant.Sensors.FirstOrDefault(x => x.Name == indicatorModel.Name);
